<template>
    <Flex
        class="border w-64 fixed bottom-0 rounded-3xl h-14 bg-dark px-8 -translate-x-[160px] transition duration-700 hover:-translate-x-[60px] group cursor-pointer"
        ...
        <Flex :justify="'center'" class="w-12 h-12 rounded-3xl p-2 bg-dark group">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#fff" viewBox="0 0 16 16"
                class="group-hover:fill-primary transition duration-700 group-hover:rotate-180 ">
                <path
