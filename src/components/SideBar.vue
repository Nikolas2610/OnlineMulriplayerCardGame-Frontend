        ...
        <div class="w-64 absolute sm:relative bg-dark shadow md:h-full flex-col justify-between hidden sm:flex">
            <div class="px-8">
                ...
                <div class="w-full flex items-center text-white text-base mt-1">
                    psillovits@gmail.com
                </div>
                <ul class="mt-12">
                    <li class="flex w-full justify-between text-gray-300 cursor-pointer items-center mb-6"
                        v-for="(item, index) in menuItems" :key="index">
                        <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-0">
                            <img :src="item.icon">
                            <span class="text-sm ml-2 text-gray-400">{{ item.name }}</span>
                        </a>
                    </li>
                    <li
                        ...
                        <a href="javascript:void(0)"
                            ...
                            <img src="@/assets/icons/sidebar/games.svg">
                            <span class="text-sm ml-2">Games</span>
                        </a>
                    </li>
                    <li
                        class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                        <a href="javascript:void(0)"
                            class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                            <img src="@/assets/icons/sidebar/tables.svg">
                            <span class="text-sm ml-2">Tables</span>
                        </a>
                    </li>
                    <li
                        class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                        <a href="javascript:void(0)"
                            class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                            <img src="@/assets/icons/sidebar/decks.svg">
                            <span class="text-sm ml-2">Decks</span>
                        </a>
                    </li>
                    <li
                        class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                        <a href="javascript:void(0)"
                            class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                            <img src="@/assets/icons/sidebar/cards.svg">
                            <span class="text-sm ml-2">Cards</span>
                        </a>
                    </li>
                    <li
                        ...
                        <a href="javascript:void(0)"
                            class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                            <img src="@/assets/icons/sidebar/settings.svg">
...
const menuItems = ref([
    {
        name: 'Dashboard', icon: `require(@/assets/icons/sidebar/games.svg)`
    },
    { name: 'Games', icon: '' },
    { name: 'Tables', icon: '' },
    { name: 'Decks', icon: '' },
